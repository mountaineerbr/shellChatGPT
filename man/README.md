...
- mountaineerbr
date: February 2025
title: CHATGPT.SH(1) v0.94 \| General Commands Manual
---
...
Whisper and TTS may handle optional positional parameters before the
text prompt itself.
...
version 1 (not all endpoints or options will be covered).
