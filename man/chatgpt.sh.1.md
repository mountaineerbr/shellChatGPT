% CHATGPT.SH(1) v0.74 | General Commands Manual
% mountaineerbr
% August 2024
...
With **vision models**, append image files and possibly URLs at
the end of the prompt. Make sure file paths containing spaces are
backslash-escaped.

_Filepaths_ that contain white spaces may need backslash-escaping
in some functions.
